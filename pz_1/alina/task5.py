...
dict_info = {
    "родиатор": ["аллюминий", 230, 10],
    "подшипник": ["16 ступны1", 470, 15],
    "лобовое зеркало": ["2 такта стекла", 170, 3],
    "боковое зеркало": ["цвет серебро", 345, 8],
    "бампер": ["цвет белый", 324, 11],
    "колесо": ["белшина", 215, 9]
}
while True:
    print("\n-----------------------")
